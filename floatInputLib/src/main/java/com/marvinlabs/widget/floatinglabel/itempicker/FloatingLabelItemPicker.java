...
//        setSelectedIndices(selectedIndices);
    ...
    public Collection<ItemT> getSelectedItems() {
        ...
        for (int index : selectedIndices) {
            if(availableItems.size() > index) items.add(availableItems.get(index));
        }
    ...
    protected void onSelectedItemsChanged() {
        ...
        if (itemPickerListener != null && selectedItems != null && selectedItems.size() > 0) itemPickerListener.onSelectionChanged(this, selectedItems);
    }
