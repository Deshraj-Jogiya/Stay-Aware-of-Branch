...
public class SlidingFragmentActivity extends FragmentActivity implements SlidingActivityBase {
	...
	public String getLangDirection(Context mContext) {
	...
	public void onAttachedToWindow() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
			getWindow().getDecorView().setLayoutDirection(getLangDirection(getBaseContext()).equals("ar") ? View.LAYOUT_DIRECTION_RTL : View.LAYOUT_DIRECTION_LTR);
		}
	}*/
	@Override
	protected void onStart() {
		...
		Locale locale = new Locale(getLangDirection(getBaseContext()));
	...
	protected void attachBaseContext(Context newBase) {
		super.attachBaseContext(MyContextWrapper.wrap(newBase, getLangDirection(newBase)));
	}
