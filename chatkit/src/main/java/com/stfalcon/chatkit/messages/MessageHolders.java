...
public class MessageHolders {
    ...
    private Class<? extends ViewHolder<String>> dateHeaderHolder;
     ...
     * @return {@link MessageHolders} for subsequent configuration.
     */
    public MessageHolders setDateHeaderHolder(@NonNull Class<? extends ViewHolder<String>> holder) {
        this.dateHeaderHolder = holder;
        return this;
    }
    ...
    * */
     ...
     */
    public static class DefaultDateHeaderViewHolder extends ViewHolder<String>
